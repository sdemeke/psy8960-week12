...
```{r}
#check empty entries
check <- tm_index(io_corpus, FUN = function(x) { return(nchar(stripWhitespace(x$content)[[1]]) > 0) } )
#returns TRUE for all 975 so i have no empty entries
...
#  <<DocumentTermMatrix (documents: 975, terms: 3659)>>
# Non-/sparse entries: 4067/3563458
# Sparsity           : 100%
# Maximal term length: 37
# Weighting          : term frequency (tf)

#if i set min=1,max=2
# <<DocumentTermMatrix (documents: 975, terms: 5254)>>
# Non-/sparse entries: 8805/5113845
# Sparsity           : 100%
# Maximal term length: 37
# Weighting          : term frequency (tf)
...
#original N:k was 975/5254
#slimmed N:k is 975/442 or 2.2
